...
| `hl7-fhir-r4` | 4.0.1 (FHIR R4), CodeSystem snapshots retrieved 2026-09-24 | Open. FHIR is published under Creative Commons "No Rights Reserved" (CC0). The three CodeSystem resources (`medicationrequest-status`, `medication-statement-status`, `data-absent-reason`) are committed byte-verbatim under `sources/hl7-fhir-r4/`; the lifecycle class assigned to each code is this project's curation. | https://hl7.org/fhir/R4/license.html |
| `cascade-curation` | 2026-09 | Open. This project's own curation over open code systems (the medication status synonyms). Redistributable as CC-BY-4.0. | https://github.com/the-cascade-protocol/cascade-knowledge/blob/main/sources/cascade-curation/medication_status_synonyms.json |
