...
| `cascade-curation` | 2026-09 | Open. This project's own curation over open code systems (the medication status synonyms). Redistributable as CC-BY-4.0. | https://hl7.org/fhir/R4/valueset-medication-statement-status.html |
